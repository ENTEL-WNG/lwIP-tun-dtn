...
void init_config(void) {
    ...
    fetch_env_string("HOST_TUN_IPV6_ADDR", dtn_config.HOST_TUN_IPV6_ADDR,
                     sizeof(dtn_config.HOST_TUN_IPV6_ADDR));
    fetch_env_string("HOST_LWIP_IPV6_ADDR", dtn_config.HOST_LWIP_IPV6_ADDR,
                     sizeof(dtn_config.HOST_LWIP_IPV6_ADDR));
    load_interfaces();
