// lwipopts.h: LwIP configuration file customized for IPv6-only DTN operations with disabled IPv4
// support Copyright (C) 2025 Michael Karpov
//
...
#define MEM_SIZE (1024 * 1024 * 128) /* 100 MiB */
